...
public enum StateType {
  ...
  /** -- GETTER -- The full, unabbreviated name of this state. */
  String unabbreviated;

  String ANSIabbreviation;
  String ISOabbreviation;

  StateType(String unabbreviated, String ANSIabbreviation, String ISOabbreviation) {
  ...
  /**
   * Parse string input to enum. Accepts unabbreviated and abbreviated forms. Case insensitive.
   *
   * @param input String to parse
   * @return The parsed US state, or null on failure.
   */
  public static StateType parse(String input) {
    if (null == input) {
      return null;
    }
    input = input.trim();
